...
先说 Harness 到底解决了什么问题
```

**规则**：
- H2 标题格式：`## 一、标题名` 或 `## 01. 标题名`
- H2 下第一行写编号（01、02、03...），独占一行
- 编号后跟一句话概括本节核心，让扫读读者也能抓重点
- 编号给读者进度感（“还有 3 个就看完了”）

### 加粗密度

关键结论必须加粗，方便跳读的读者也能抓住重点：

- 每个 H2 段落至少 2-3 处加粗
- 加粗的是**结论和观点**，不是名词或术语
- 金句整句加粗
- 禁止连续 3 个 H2 段落没有加粗（会导致跳读读者流失）

### 签名栏

文章开头（头图之后、正文之前）加固定签名栏：
...
作用：建立作者品牌认知，显得更专业。可选，不影响内容质量。

### 引用块（blockquote）

重要结论或公式用引用块包装，视觉上从正文中跳出来：
